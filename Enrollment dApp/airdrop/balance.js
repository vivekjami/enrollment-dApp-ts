...
var keypair = web3_js_1.Keypair.fromSecretKey(new Uint8Array(dev_wallet_1.default));
...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                balance = _a.sent();
                console.log("The account balance is ".concat(balance / web3_js_1.LAMPORTS_PER_SOL, " SOL"));
                return [3 /*break*/, 3];
            case 2:
                e_1 = _a.sent();
